  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Gerencie todas as configurações do HustFofin</p>
      </div>
                  ...
                  <AlertDialogAction
                    onClick={async () => {
                      try {
                        ...
                        window.electronAPI?.notification.show({ title: "HustFofin", body: "Todos os dados foram apagados. Reinicie o app." })
